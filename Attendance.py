...
# Set up variables
password = ""
students = [("You", 1234,"123.4.1.6",99), ("Emily", 5678,"123.4.5.4",99), ("Mike", 9012,"122.4.5.6",92), ("Sara", 3456,"133.4.5.6",95), ("David", 7890,"123.9.5.6",99),
            ("Anna", 2345,"123.4.3.6",99), ("Tom", 6789,"123.4.5.1",100), ("Julia", 123,"121.4.5.6",99), ("Peter", 4567,"113.4.5.6",92), ("Mary", 8901,"123.8.5.6",99),
            ("Jake", 5432,"123.4.1.6",98), ("Olivia", 9876,"123.4.5.2",100), ("Nick", 3210,"120.4.5.6",93), ("Eva", 7654,"103.4.5.6",97), ("Sam", 1098,"123.7.5.6",91)]
